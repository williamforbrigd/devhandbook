...
const PATHS: Record<string, React.ReactNode> = {
  ...
  cpu: <><rect x="4" y="4" width="16" height="16" rx="2" /><rect x="9" y="9" width="6" height="6" /><line x1="9" x2="9" y1="2" y2="4" /><line x1="15" x2="15" y1="2" y2="4" /><line x1="9" x2="9" y1="20" y2="22" /><line x1="15" x2="15" y1="20" y2="22" /><line x1="20" x2="22" y1="9" y2="9" /><line x1="20" x2="22" y1="15" y2="15" /><line x1="2" x2="4" y1="9" y2="9" /><line x1="2" x2="4" y1="15" y2="15" /></>,
  ...
  alertOctagon: <><polygon points="7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2" /><path d="M12 8v4" /><path d="M12 16h.01" /></>,
  archive: <><rect x="2" y="4" width="20" height="5" rx="2" /><path d="M4 9v9a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9" /><path d="m9 13 3 3 3-3" /></>,
}

export type IconName = keyof typeof PATHS | string

/**
 * Normalise a Lucide-style icon name (e.g. "BookOpen", "book-open", "book_open")
 * to our camelCase key format (e.g. "bookOpen").
 */
function normalise(name: string): string {
  // split on -, _ or spaces; then camelCase, lowercasing the first segment.
...
export function Icon({
  ...
  const paths = PATHS[key] ?? PATHS[name] ?? FALLBACK
